...
/** Multiple Post Thumbnails activation 
 *
 */
...
function add_custom_taxonomies() {
	// Add new "spotlight" taxonomy to Posts
	register_taxonomy('spotlight', 'post', array(
		//Hierarchical taxonomy (Like Categories)
		'Hierarchical' => true,
		// Array for controlling labels displayed in WP Admin UI
		'labels' => array(
			'name' => _x( 'featured', 'taxonomy general name' ),
			'singular_name' => __( 'featured', 'taxonomy singular name' ),
			'search_items' => __( 'Search Featured Posts' ),
			'all_items' => __( 'All Featured Posts' ),
			'parent_item' => __( 'Parent Featured Post' ),
      		'parent_item_colon' => __( 'Parent Featured Post:' ),
      		'edit_item' => __( 'Edit Featured Post' ),
      		'update_item' => __( 'Update Featured Post' ),
      		'add_new_item' => __( 'Add New Featured Post' ),
      		'new_item_name' => __( 'New Featured Post' ),
      		'menu_name' => __( 'Featured Posts' ),
			),
		// Control slugs used for this taxonomy
		'rewrite' => array(
			'slug' => 'featured-post', // Controls base slug before each term
			'with-front' => false, // don't display category base before '/featured-posts'
			'hierarchical' => true
			),
		));
	}
